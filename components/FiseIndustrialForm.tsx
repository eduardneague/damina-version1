  ...
  const handleSubmit = (e: any) => {
    ...
    setFinalDraft(`
      ...
      formData.zona
            ...
            Te rog foarte mult, sub absolut nicio forma, sa nu folosesti diacriticele limbii romane, foloseste literele alfabetului englezesc, 
            dar compunerea sa fie in limba romana.
